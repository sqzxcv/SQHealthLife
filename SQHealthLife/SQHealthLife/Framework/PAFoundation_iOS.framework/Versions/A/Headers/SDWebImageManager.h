...
typedef void(^SDWebImageCompletedBlock)(UIImage *image, NSError *error, PACacheType cacheType);

typedef void(^SDWebImageCompletedWithFinishedBlock)(UIImage *image, NSError *error, PACacheType cacheType, BOOL finished);
...
@property (strong, nonatomic, readonly) PACache *imageCache;
