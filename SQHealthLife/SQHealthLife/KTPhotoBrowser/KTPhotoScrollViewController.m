...
@interface KTPhotoScrollViewController (KTPrivate) <KTPhotoBrowserDataSource>
...
- (void)loadView 
{
   ...
   [newView release];
    ...
    if ([self.resourceItem[kResourceType] isEqualToString:kResourceSeedType])
    {
...
{
    NSArray *images = self.resourceItem[kResourceFilesTypeImages];
    return [images count];
}
...
- (UIImage *)imageAtIndex:(NSInteger)index
{
    ...
    else if ([self.resourceItem[kResourceType] isEqualToString:kResourcePhotoType])
    {
